...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		uiGroup.add(timeBar);
		if (ClientPrefs.data.timeHealthColors) {
	...
	function tryPlayCountSound(sound:Sound) {
		if (sound != null) {
	...
	public function startCountdown()
	{
		...
		if(ret != LuaUtils.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
			{
				...
				{
					case 0:
						tryPlayCountSound(Paths.sound('intro3' + introSoundsSuffix));
						tick = THREE;
					case 1:
						countdownReady = createCountdownSprite(introAlts[0], antialias);
						tryPlayCountSound(Paths.sound('intro2' + introSoundsSuffix));
						tick = TWO;
					case 2:
						countdownSet = createCountdownSprite(introAlts[1], antialias);
						tryPlayCountSound(Paths.sound('intro1' + introSoundsSuffix));
						tick = ONE;
					case 3:
						countdownGo = createCountdownSprite(introAlts[2], antialias);
						tryPlayCountSound(Paths.sound('introGo' + introSoundsSuffix));
						tick = GO;
					case 4:
						tick = START;
				}
	...
	override public function update(elapsed:Float)
	{
		...
		#if debug
		if(FlxG.keys.justPressed.F1) { // TODO remove this
			KillNotes();
			endSong();
		}
		#end
